...
public class IPCIncludeStatementImpl extends ASTWrapperPsiElement implements IPCIncludeStatement {

  public IPCIncludeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public IPCHeader getHeader() {
    return findNotNullChildByClass(IPCHeader.class);
  }
