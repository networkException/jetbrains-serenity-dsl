...
public class IPCParserDefinition implements ParserDefinition {

    public static final TokenSet WHITE_SPACES = TokenSet.create(TokenType.WHITE_SPACE);
    public static final TokenSet COMMENTS = TokenSet.create(IPCTypes.COMMENT);
    public static final TokenSet PATHS = TokenSet.create(IPCTypes.PATH);

    public static final IFileElementType FILE = new IFileElementType(IPCLanguage.INSTANCE);
    ...
    @Override public PsiFile createFile(FileViewProvider viewProvider) {
        return new IPCFile(viewProvider);
    }
    ...
    @NotNull @Override public PsiElement createElement(ASTNode node) {
        return IPCTypes.Factory.createElement(node);
    }
